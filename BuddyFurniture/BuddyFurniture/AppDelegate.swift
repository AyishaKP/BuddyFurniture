...
@UIApplicationMain
class AppDelegate: UIResponder, UIApplicationDelegate, OnboardProtocol {
    ...
    func didOnboard() {
        let tabVC = StoryboardManager.shared.homeTabBar().instantiateInitialViewController() as? TabBarViewController
